...
type Config struct {
	...
	// two format characters zeus, and cloud. for example: snake format you can
	// define as zeus_cloud, camel case format you can it is defined as goZero,
